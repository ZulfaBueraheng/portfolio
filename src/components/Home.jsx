const Home = () => {
  return (
    <section
      id="home"
      className="flex items-center justify-center h-screen  sm:h-[512px] md:h-[590px] lg:min-h-screen bg-[#e9ebed] bg-[url('data:image/svg+xml,%3Csvg%20width=%2764%27%20height=%2780%27%20viewBox=%270%200%2064%2080%27%20xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cg%20fill=%27%23dcdfe3%27%20fill-opacity=%270.4%27%20fill-rule=%27evenodd%27%3E%3Cpath%20d=%27M32%200v80L0%2040M64%200v40L32%200M64%2040v40H32%27/%3E%3C/g%3E%3C/svg%3E')] bg-repeat sm:bg-[#DCDFE3] md:bg-none text-white"
    >
      <div className="absolute sm:-left-65 lg:-left-85 xl:-left-65 sm:top-[256px] md:top-[295px] lg:top-1/2 -translate-y-1/2 mt-6 sm:h-100 lg:h-140 xl:h-160 sm:w-100 md:w-120 lg:w-140 xl:w-160 rounded-full bg-[#E9EBED]"></div>
