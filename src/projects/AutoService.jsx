      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-6 xl:p-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-6 xl:p-8">
              <h3 className="text-base sm:text-lg xl:text-xl font-bold mb-6 text-gray-800">
                Key Features
              </h3>
              <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-6">
              <h3 className="text-base sm:text-lg xl:text-xl font-bold mb-4 text-gray-800">
                Technologies Used
              </h3>
              <div className="space-y-4 ">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-6 text-sm sm:text-base">
              <h3 className="text-base sm:text-lg xl:text-xl font-bold mb-4 text-gray-800">
                Project Highlights
              </h3>
              <div className="space-y-4">
